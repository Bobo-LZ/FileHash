...
{
    return (__bridge_transfer NSString *)FileSHA256CreateWithPath((__bridge CFStringRef)path, FileHashDefaultChunkSizeForReadingData);
}

CFStringRef FileSHA256CreateWithPath(CFStringRef filePath,size_t chunkSizeForReadingData) {
